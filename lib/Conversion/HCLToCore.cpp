...
namespace {
struct HCLToCoreLoweringPass
    : public HCLToCoreLoweringBase<HCLToCoreLoweringPass> {
  void runOnOperation() override {
    auto module = getOperation();
    if (!applyHCLToCoreLoweringPass(module, getContext()))
      signalPassFailure();
  }
};
} // namespace
...
std::unique_ptr<OperationPass<ModuleOp>> createHCLToCoreLoweringPass() {
  return std::make_unique<HCLToCoreLoweringPass>();
}
} // namespace hcl
} // namespace mlir
